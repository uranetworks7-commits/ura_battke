...
export default function Home() {
  ...
  return (
    <main className="h-screen w-screen flex flex-col bg-background font-body" style={{ backgroundImage: `url('https://i.postimg.cc/y8ZBRDXQ/mmm.png')`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
